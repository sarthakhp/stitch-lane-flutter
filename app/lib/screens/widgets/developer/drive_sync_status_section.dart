...
/// Developer-only comparison of local vs. Drive record counts (customers,
/// orders, measurements, images, audio) with a per-row in-sync indicator.
class DriveSyncStatusSection extends StatefulWidget {
  const DriveSyncStatusSection({super.key});

  @override
  State<DriveSyncStatusSection> createState() =>
      _DriveSyncStatusSectionState();
}

class _DriveSyncStatusSectionState extends State<DriveSyncStatusSection> {
