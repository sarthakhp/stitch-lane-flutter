...
class Pricing {
  ...
  static final Map<String, PricingEntry> _table = {
    ...
    //   gemini-3.5-flash-lite  in 0.10 / out 0.40  (same tier as 3.1-flash-lite)
    //   gemini-2.5-flash       in 0.30 / out 2.50
    //   gemini-2.5-flash-lite  in 0.10 / out 0.40
    //   gemini-2.0-flash       in 0.10 / out 0.40
    _key(UsageProvider.gemini, 'gemini-3.5-flash-lite', UsageKind.chat):
        const PricingEntry(inputPerMillion: 0.10, outputPerMillion: 0.40),
    _key(UsageProvider.gemini, 'gemini-3.5-flash-lite', UsageKind.multimodal):
        const PricingEntry(inputPerMillion: 0.10, outputPerMillion: 0.40),
